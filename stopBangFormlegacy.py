...
try:
    ...
    try:
        ...
        mongo_query = {"form.reference": {"$in": stopBangFormIds}}
    ...
    for document in mongo_results:
        ...
        mysql_values = (
                ...
                bang_inch_value, osScore, form_date, form_response_id, status, patientId,markToBeDeleted,lastUpdatedBy, mongo_date_created,
                mongo_last_updated
            )
        ...
        try:
            if len(batch) >= batch_size:
                config.mysql_cursor.executemany(
                    "INSERT INTO stopBangForm (mongo_id, service_request_id, created_by_user, patient_name, patient_DOB, age, gender, height, weight, bmi, surgeon_name, date_of_surgery, stop_snore_yes, stop_snore_no, stop_daytime_yes, stop_daytime_no, stop_sleep_yes, stop_sleep_no, stop_bp_yes, stop_bp_no, bang_bmi_yes, bang_bmi_no, bang_age_yes, bang_age_no, bang_ncm_yes, bang_ncm_no, bang_gender_yes, bang_gender_no, bang_enter, bang_inch_code, bang_inch_value, os_score, form_date, form_response_id, status, patientId,markToBeDeleted,lastUpdatedBy,mongo_date_created, mongo_last_updated) VALUES (%s,%s,%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                    batch
                )
