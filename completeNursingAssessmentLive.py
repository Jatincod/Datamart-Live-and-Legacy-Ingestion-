...
try:
    ...
    try:
        ...
        print(f"Going to fetch latest mongo_last_updated in completeNursingAssessmentPartA Table")

        config.mysql_cursor.execute("SELECT mongo_last_updated FROM completeNursingAssessmentPartA ORDER BY mongo_last_updated DESC LIMIT 1")
        latest_record = config.mysql_cursor.fetchone()

        if latest_record:
            latest_mongo_lastUpdated = latest_record[0]
            print(f"Found latest mongo_last_updated in completeNursingAssessmentPartA as {latest_mongo_lastUpdated}")
            print(f"Going to fetch data from formResponse collection for completeNursingAssessment after  {latest_mongo_lastUpdated}")

            mongo_query = {"form.reference": {"$in": completeNursingAssessmentIds},"lastUpdated": { "$gt": latest_mongo_lastUpdated }}
    ...
    # Fetch existing record
        config.mysql_cursor.execute("SELECT id FROM completeNursingAssessmentPartA WHERE mongo_id = %s", (mongo_id,))
        ...
        # If the record exists, perform an UPDATE operation
            ...
            try:
                config.mysql_cursor.execute("UPDATE completeNursingAssessmentPartA SET service_request_id = %s, created_by_user = %s, patientName = %s, patientDob = %s, datOfSurgery = %s, surgeryName = %s, surgeonName = %s, primaryPhon = %s, alternatePhon = %s, patientPreferredLanguage = %s, otherPreferredLanguage = %s, interpreterRequired_family = %s, interpreterRequired_language_line_id_number = %s, patientDesignated = %s, informationObtained = %s, languageLineId = %s, advancedDirectives_yes = %s, advancedDirectives_no = %s, copyOnChart_yes = %s, copyOnChart_no = %s, allergies_no_known_allergy = %s, allergies_yes = %s, allergiesTo = %s, allergies_reactions = %s, surgicalHistory_denied = %s, surgicalHistory_yes = %s, surgicalHistoryYes = %s, anesthesiaHistory_yes = %s, anesthesiaHistory_no = %s, bloodRelatives_yes = %s, bloodRelatives_no = %s, adverseReaction_yes = %s, adverseReaction_no = %s, reactions1 = %s, currentlyPain_yes = %s, currentlyPain_no = %s, painScale = %s, painQuality = %s, scaleType_Numerical = %s, scaleType_face_ = %s, scaleType_flacc__ = %s, scaleType_pain_ad = %s, painDuration_value = %s, painLocation = %s, visualImpairment_yes = %s, visualImpairment_no = %s, visualImpairmentText = %s, auditoryImpairment_yes = %s, auditoryImpairment_no = %s, auditoryImpairmentText = %s, congnitiveImpairment_yes = %s, congnitiveImpairment_no = %s, congnitiveImpairmentText = %s, barriersToLearning_yes = %s, barriersToLearning_no = %s, learningBarrierType_value = %s, ifOther = %s, mobilityImpairment_yes = %s, mobilityImpairment_no = %s, mobilityImpairment_value = %s, fallRiskAssessment_all_surgical_patients = %s, fallRiskAssessment_fall_with_harm_risk = %s, yellowWristband_needs_assistance = %s, yellowWristband_current_falls = %s, yellowWristband_85_years = %s, yellowWristband_bone_condition = %s, yellowWristband_has_bleeding_disorder = %s, reportedNurologicProblem_yes = %s, reportedNurologicProblem_no = %s, seizures_yes = %s, seizures_no = %s, lastEpisode = %s, onMeds_yes = %s, onMeds_no = %s, seizureHeadachesMigraines_yes = %s, seizureHeadachesMigraines_no = %s, frequency = %s, lastEpisode1 = %s, onMeds1_no = %s, onMeds1_yes = %s, strokeCVATIA_yes = %s, strokeCVATIA_no = %s, lastEpisode2 = %s, weakness = %s, vpShuntPlace_yes = %s, vpShuntPlace_no = %s, VpShunt = %s, cronicDizziness_yes = %s, cronicDizziness_no = %s, lastEpisode3 = %s, onMeds2_yes = %s, onMeds2_no = %s, comment = %s, cardiovascularProblem_yes = %s, cardiovascularProblem_no = %s, hypertension_yes = %s, hypertension_no = %s, mi_yes = %s, mi_no = %s, dateOfEvent = %s, angina_yes = %s, angina_no = %s, lastEpisode4 = %s, chestPain_yes = %s, chestPain_no = %s, describe_ = %s, arterioscleroticHeartDisease_yes = %s, arterioscleroticHeartDisease_no = %s, onset = %s, congestiveHeartFailure_yes = %s, congestiveHeartFailure_no = %s, onset1 = %s, swellingOfAnklesFeet_yes = %s, swellingOfAnklesFeet_no = %s, pitting_yes = %s, pitting_no = %s, arrhythmia_yes = %s, arrhythmia_no = %s, typeArrhythmia = %s, murmurs_yes = %s, murmurs_no = %s, peripheralVascularDisease_yes = %s, peripheralVascularDisease_no = %s, otherPeripheral = %s, pacemaker_yes = %s, pacemaker_no = %s, pacemakerDate = %s, aicd_yes = %s, aicd_no = %s, aicdDate = %s, cardiackStentBypass_yes = %s, cardiackStentBypass_no = %s, cardiack = %s, pastBloodTransfusions_yes = %s, pastBloodTransfusions_no = %s, transfusionsReson = %s, transfusionsDate = %s, adverseReaction1_yes = %s, adverseReaction1_no = %s, describe3 = %s, active_yes = %s, active_no = %s, active1 = %s, withoutStoping_yes = %s, withoutStoping_no = %s, flights = %s, atolerateLyingFlatPeriodOfTime_yes = %s, atolerateLyingFlatPeriodOfTime_no = %s, tolerate = %s, onMeds3_yes = %s, onMeds3_no = %s, comment1 = %s, form_response_id = %s, status = %s, patientId = %s, lastUpdatedBy = %s, markToBeDeleted = %s, mongo_date_created = %s, mongo_last_updated = %s WHERE mongo_id = %s ",(service_request_id, created_by_user, patientName, patientDob, datOfSurgery, surgeryName, surgeonName, primaryPhon, alternatePhon, patientPreferredLanguage, otherPreferredLanguage, interpreterRequired_family, interpreterRequired_language_line_id_number, patientDesignated, informationObtained, languageLineId, advancedDirectives_yes, advancedDirectives_no, copyOnChart_yes, copyOnChart_no, allergies_no_known_allergy, allergies_yes, allergiesTo, allergies_reactions, surgicalHistory_denied, surgicalHistory_yes, surgicalHistoryYes, anesthesiaHistory_yes, anesthesiaHistory_no, bloodRelatives_yes, bloodRelatives_no, adverseReaction_yes, adverseReaction_no, reactions1, currentlyPain_yes, currentlyPain_no, painScale, painQuality, scaleType_Numerical, scaleType_face_, scaleType_flacc__, scaleType_pain_ad, painDuration_value, painLocation, visualImpairment_yes, visualImpairment_no, visualImpairmentText, auditoryImpairment_yes, auditoryImpairment_no, auditoryImpairmentText, congnitiveImpairment_yes, congnitiveImpairment_no, congnitiveImpairmentText, barriersToLearning_yes, barriersToLearning_no, learningBarrierType_value, ifOther, mobilityImpairment_yes, mobilityImpairment_no, mobilityImpairment_value, fallRiskAssessment_all_surgical_patients, fallRiskAssessment_fall_with_harm_risk, yellowWristband_needs_assistance, yellowWristband_current_falls, yellowWristband_85_years, yellowWristband_bone_condition, yellowWristband_has_bleeding_disorder, reportedNurologicProblem_yes, reportedNurologicProblem_no, seizures_yes, seizures_no, lastEpisode, onMeds_yes, onMeds_no, seizureHeadachesMigraines_yes, seizureHeadachesMigraines_no, frequency, lastEpisode1, onMeds1_no, onMeds1_yes, strokeCVATIA_yes, strokeCVATIA_no, lastEpisode2, weakness, vpShuntPlace_yes, vpShuntPlace_no, VpShunt, cronicDizziness_yes, cronicDizziness_no, lastEpisode3, onMeds2_yes, onMeds2_no, comment, cardiovascularProblem_yes, cardiovascularProblem_no, hypertension_yes, hypertension_no, mi_yes, mi_no, dateOfEvent, angina_yes, angina_no, lastEpisode4, chestPain_yes, chestPain_no, describe_, arterioscleroticHeartDisease_yes, arterioscleroticHeartDisease_no, onset, congestiveHeartFailure_yes, congestiveHeartFailure_no, onset1, swellingOfAnklesFeet_yes, swellingOfAnklesFeet_no, pitting_yes, pitting_no, arrhythmia_yes, arrhythmia_no, typeArrhythmia, murmurs_yes, murmurs_no, peripheralVascularDisease_yes, peripheralVascularDisease_no, otherPeripheral, pacemaker_yes, pacemaker_no, pacemakerDate, aicd_yes, aicd_no, aicdDate, cardiackStentBypass_yes, cardiackStentBypass_no, cardiack, pastBloodTransfusions_yes, pastBloodTransfusions_no, transfusionsReson, transfusionsDate, adverseReaction1_yes, adverseReaction1_no, describe3, active_yes, active_no, active1, withoutStoping_yes, withoutStoping_no, flights, atolerateLyingFlatPeriodOfTime_yes, atolerateLyingFlatPeriodOfTime_no, tolerate, onMeds3_yes, onMeds3_no, comment1,  form_response_id, status, patientId, lastUpdatedBy, markToBeDeleted, mongo_date_created, mongo_last_updated ,mongo_id))
                print("Executed UPDATE for document with mongo_id in completeNursingAssessmentPartA:", mongo_id)

                config.mysql_cursor.execute("UPDATE completeNursingAssessmentPartB SET service_request_id = %s, respiratoryProblem_yes = %s, respiratoryProblem_no = %s, sleepApnea_yes = %s, sleepApnea_no = %s, daignosed = %s, sleepStudyDone_yes = %s, sleepStudyDone_no = %s, sleepStudyDone_uses_cpap = %s, asthma_yes = %s, asthma_no = %s, lastEpisode5 = %s, lastHospitalization = %s, intubation_yes = %s, intubation_no = %s, intubationYes = %s, chronicCoughBronchitis_yes = %s, chronicCoughBronchitis_no = %s, lastEpisode6 = %s, lastHospitalization1 = %s, intubation1_yes = %s, intubation1_no = %s, intubationYes1 = %s, emphysema_yes = %s, emphysema_no = %s, lastEpisode7 = %s, lastHospitalization2 = %s, intubation2_yes = %s, intubation2_no = %s, intubationYes2 = %s, pneumonia_yes = %s, pneumonia_no = %s, lastEpisode8 = %s, lastHospitalization3 = %s, intubation3_yes = %s, intubation3_no = %s, intubationYes3 = %s, tuberculosis_yes = %s, tuberculosis_no = %s, lastEpisode9 = %s, lastHospitalization4 = %s, intubation4_yes = %s, intubation4_no = %s, intubationYes4 = %s, recentUpperRespiratoryInfection_yes = %s, recentUpperRespiratoryInfection_no = %s, lastEpisode01 = %s, lastHospitalization05 = %s, intubation5_yes = %s, intubation5_no = %s, intubationYes5 = %s, lastEpisodeOther = %s, lastEpisode02 = %s, lastHospitalization7 = %s, intubation7_yes = %s, intubation7_no = %s, intubationYes7 = %s, onMeds4_yes = %s, onMeds4_no = %s, comment2 = %s,reportedGastroinestinalProblem_yes = %s, reportedGastroinestinalProblem_no = %s, curentDiet = %s, difficultySwallowing_yes = %s, difficultySwallowing_no = %s, pepticUlcerDisease_yes = %s, pepticUlcerDisease_no = %s, gerdHeartBurn_yes = %s, gerdHeartBurn_no = %s, hiatalHernia_yes = %s, hiatalHernia_no = %s, hepatitis_yes = %s, hepatitis_no = %s, hepatitisType = %s, hepatitisDiagnosed = %s, hepatitisTreated = %s, irritableBowelSyndromeCrohn_yes = %s, irritableBowelSyndromeCrohn_no = %s, bowelActivity = %s, unintentionalweightLoss_yes = %s, unintentionalweightLoss_no = %s, onMeds5_yes = %s, onMeds5_no = %s, comment3 = %s, reportRenalProblem_yes = %s, reportRenalProblem_no = %s, kidneyDisease_yes = %s, kidneyDisease_no = %s, urinaryInfections_yes = %s, urinaryInfections_no = %s, enlargedProstate_yes = %s, enlargedProstate_no = %s, difficultyUrinating_yes = %s, difficultyUrinating_no = %s, bloodUrine_yes = %s, bloodUrine_no = %s, onDialysis_yes = %s, onDialysis_no = %s, dialysisDays = %s, dialysisType = %s, shuntFistualAccess_yes = %s, shuntFistualAccess_no = %s, selfCatherization_yes = %s, selfCatherization_no = %s, otherCatherization = %s, onMeds6_yes = %s, onMeds6_no = %s, comments = %s, reportedMusculoskeletalProblem_yes = %s, reportedMusculoskeletalProblem_no = %s, arthritis_yes = %s, arthritis_no = %s, gout_yes = %s, gout_no = %s, osteoperosis_yes = %s, osteoperosis_no = %s, muscleWeakness_yes = %s, muscleWeakness_no = %s, fractures = %s, others = %s, onMeds7_yes = %s, onMeds7_no = %s, musculoskeletalComment = %s, reportedHematologyProblem_yes = %s, reportedHematologyProblem_no = %s, bloodTransfusions_yes = %s, bloodTransfusions_no = %s, bloodTransfusionsReason = %s, bloodTransfusionsDate = %s, adverseReactions_yes = %s, adverseReactions_no = %s, adverseReactionsDescribe = %s, bleedingProblem_yes = %s, bleedingProblem_no = %s, bruiseEasily_yes = %s, bruiseEasily_no = %s, sickleCellDisease_yes = %s, sickleCellDisease_no = %s, hivAIDS_yes = %s, hivAIDS_no = %s, leukemia_yes = %s, leukemia_no = %s, leukemiaYes = %s, treatmentType_chemotherapy = %s, treatmentType_bone_marrow_transplant = %s, cancer_yes = %s, cancer_no = %s, treatmentTypeCancer__chemotherapy = %s, treatmentTypeCancer_radiation_therapy = %s, onMedsHematology_yes = %s, onMedsHematology_no = %s, hematologyComment = %s, endocrineProblem_yes = %s, endocrineProblem_no = %s, diabetes_yes = %s, diabetes_no = %s, type_type_i = %s, type_type_ii = %s, diabetesDate = %s, BloodGlucose_yes = %s, BloodGlucose_no = %s, bloodGlucoseMonitoring = %s, lowRnge = %s, highRange = %s, hospitalizationDiabetes = %s, reason = %s, thyroidDisease_yes = %s, thyroidDisease_no = %s, HistorySteroidUse_yes = %s, HistorySteroidUse_no = %s, steroidHistory = %s, onMeds8_yes = %s, onMeds8_no = %s, EndocrineComment = %s WHERE mongo_id = %s ",(service_request_id, respiratoryProblem_yes, respiratoryProblem_no, sleepApnea_yes, sleepApnea_no, daignosed, sleepStudyDone_yes, sleepStudyDone_no, sleepStudyDone_uses_cpap, asthma_yes, asthma_no, lastEpisode5, lastHospitalization, intubation_yes, intubation_no, intubationYes, chronicCoughBronchitis_yes, chronicCoughBronchitis_no, lastEpisode6, lastHospitalization1, intubation1_yes, intubation1_no, intubationYes1, emphysema_yes, emphysema_no, lastEpisode7, lastHospitalization2, intubation2_yes, intubation2_no, intubationYes2, pneumonia_yes, pneumonia_no, lastEpisode8, lastHospitalization3, intubation3_yes, intubation3_no, intubationYes3, tuberculosis_yes, tuberculosis_no, lastEpisode9, lastHospitalization4, intubation4_yes, intubation4_no, intubationYes4, recentUpperRespiratoryInfection_yes, recentUpperRespiratoryInfection_no, lastEpisode01, lastHospitalization05, intubation5_yes, intubation5_no, intubationYes5, lastEpisodeOther, lastEpisode02, lastHospitalization7, intubation7_yes, intubation7_no, intubationYes7, onMeds4_yes, onMeds4_no, comment2,reportedGastroinestinalProblem_yes, reportedGastroinestinalProblem_no, curentDiet, difficultySwallowing_yes, difficultySwallowing_no, pepticUlcerDisease_yes, pepticUlcerDisease_no, gerdHeartBurn_yes, gerdHeartBurn_no, hiatalHernia_yes, hiatalHernia_no, hepatitis_yes, hepatitis_no, hepatitisType, hepatitisDiagnosed, hepatitisTreated, irritableBowelSyndromeCrohn_yes, irritableBowelSyndromeCrohn_no, bowelActivity, unintentionalweightLoss_yes, unintentionalweightLoss_no, onMeds5_yes, onMeds5_no, comment3, reportRenalProblem_yes, reportRenalProblem_no, kidneyDisease_yes, kidneyDisease_no, urinaryInfections_yes, urinaryInfections_no, enlargedProstate_yes, enlargedProstate_no, difficultyUrinating_yes, difficultyUrinating_no, bloodUrine_yes, bloodUrine_no, onDialysis_yes, onDialysis_no, dialysisDays, dialysisType, shuntFistualAccess_yes, shuntFistualAccess_no, selfCatherization_yes, selfCatherization_no, otherCatherization, onMeds6_yes, onMeds6_no, comments, reportedMusculoskeletalProblem_yes, reportedMusculoskeletalProblem_no, arthritis_yes, arthritis_no, gout_yes, gout_no, osteoperosis_yes, osteoperosis_no, muscleWeakness_yes, muscleWeakness_no, fractures, others, onMeds7_yes, onMeds7_no, musculoskeletalComment, reportedHematologyProblem_yes, reportedHematologyProblem_no, bloodTransfusions_yes, bloodTransfusions_no, bloodTransfusionsReason, bloodTransfusionsDate, adverseReactions_yes, adverseReactions_no, adverseReactionsDescribe, bleedingProblem_yes, bleedingProblem_no, bruiseEasily_yes, bruiseEasily_no, sickleCellDisease_yes, sickleCellDisease_no, hivAIDS_yes, hivAIDS_no, leukemia_yes, leukemia_no, leukemiaYes, treatmentType_chemotherapy, treatmentType_bone_marrow_transplant, cancer_yes, cancer_no, treatmentTypeCancer__chemotherapy, treatmentTypeCancer_radiation_therapy, onMedsHematology_yes, onMedsHematology_no, hematologyComment, endocrineProblem_yes, endocrineProblem_no, diabetes_yes, diabetes_no, type_type_i, type_type_ii, diabetesDate, BloodGlucose_yes, BloodGlucose_no, bloodGlucoseMonitoring, lowRnge, highRange, hospitalizationDiabetes, reason, thyroidDisease_yes, thyroidDisease_no, HistorySteroidUse_yes, HistorySteroidUse_no, steroidHistory, onMeds8_yes, onMeds8_no, EndocrineComment,mongo_id))
                print("Executed UPDATE for document with mongo_id in completeNursingAssessmentPartB:", mongo_id)

                config.mysql_cursor.execute("UPDATE completeNursingAssessmentPartC SET service_request_id = %s, reportedSkinProblem_no = %s, reportedSkinProblem_yes = %s, intact_yes = %s, intact_no = %s, psoriasis_yes = %s, psoriasis_no = %s, eczdma_yes = %s, eczdma_no = %s, brusesCuts_yes = %s, brusesCuts_no = %s, rashesDescribe = %s, rashesDescribeOther = %s, skinComment = %s, visualImpairmentGyn_yes = %s, visualImpairmentGyn_no = %s, visualImpairmentGyn_na = %s, fynComment = %s, menstrualPeriod = %s, SapSmear = %s, dateOfLastPelvicExam = %s, pregnantNow_yes = %s, pregnantNow_no = %s, possibilityPregnantDescribe = %s, lactating_yes = %s, lactating_no = %s, peds_na = %s, deliveryType = %s, preemie = %s, birthWeight = %s, immunizationDate_yes = %s, immunizationDate_no = %s, immunizationDetails = %s, respiratoryInfection_no = %s, respiratoryInfection_yes = %s, respiratoryInfectionDetails = %s, communicableDisease_measles = %s, communicableDisease_chicken_pox = %s, communicableDisease_tb = %s, communicableDisease_meningitis = %s, communicableDisease_na = %s, communicableDiseaseOthers = %s, pedsComment = %s, culturalSurgery_yes = %s, culturalSurgery_no = %s, dayOfSurgery = %s, livesAlone_yes = %s, livesAlone_no = %s, typeOfHouse = %s, stairs = %s, alcohol_yes = %s, alcohol_no = %s, freq = %s, alcoholOther = %s, alcoholAmount = %s, drugs_yes = %s, drugs_no = %s, drugsFreq = %s, drugsOther = %s, drugslAmount = %s, lastDoseAmount = %s, caffeine_yes = %s, caffeine_no = %s, caffeineFreq = %s, caffeineOther = %s, caffeineAmount = %s, cigarettesVaping_yes = %s, cigarettesVaping_no = %s, packsPerDay = %s, lastCigarette = %s, cigars_yes = %s, cigars_no = %s, cigarsPerDay = %s, lastCigar = %s, readinessToQuit = %s, psychosocialComment = %s, reportedPsychiatricProblem_yes = %s, reportedPsychiatricProblem_no = %s, anxiety_yes = %s, anxiety_no = %s, hallucinations_yes = %s, hallucinations_no = %s, depressions_yes = %s, depressions_no = %s, postTraumaticReaction_yes = %s, postTraumaticReaction_no = %s, suicidalIdeations_yes = %s, suicidalIdeations_no = %s, suicidalOther = %s, onMeds9_yes = %s, onMeds9_no = %s, followedByMD_yes = %s, followedByMD_no = %s, psychiatricComment = %s, afraidOfAnyyone_yes = %s, afraidOfAnyyone_no = %s, afraidOfAnyyone_unable_to_access = %s, afraid = %s, unableAfraid = %s, isAnyoneHurtingYou_yes = %s, isAnyoneHurtingYou_no = %s, isAnyoneHurtingYou_unable_to_access = %s, hurting = %s, unableHurting = %s, talkSomeone_yes = %s, talkSomeone_no = %s, talkSomeone_unable_to_access = %s, unableTalk = %s, abuseScreenComments = %s, placeYouDoNotFeelSafe_yes = %s, placeYouDoNotFeelSafe_no = %s, placeYouDoNotFeelSafe_unable_to_access = %s, feelSafeYes = %s, unableFeelSafe = %s, isAnyoneHurtingYou1_yes = %s, isAnyoneHurtingYou1_no = %s, isAnyoneHurtingYou1_unable_to_access = %s, hurtingYes = %s, unableToHurting = %s, afraidOfAnyone_yes = %s, afraidOfAnyone_no = %s, afraidOfAnyone_unable_to_access = %s, personAfraid = %s, otherPersonAfraid = %s, unableToAssess = %s, abuseScreenComments1 = %s, nameOfPhysician = %s, nameOfPhysicianDate = %s, nameOfPhysicianTime = %s, nameOfSocialWorker = %s, nameOfSocialWorkerDate = %s, nameOfSocialWorkerTime = %s WHERE mongo_id = %s ",(service_request_id,reportedSkinProblem_no, reportedSkinProblem_yes, intact_yes, intact_no, psoriasis_yes, psoriasis_no, eczdma_yes, eczdma_no, brusesCuts_yes, brusesCuts_no, rashesDescribe, rashesDescribeOther, skinComment, visualImpairmentGyn_yes, visualImpairmentGyn_no, visualImpairmentGyn_na, fynComment, menstrualPeriod, SapSmear, dateOfLastPelvicExam, pregnantNow_yes, pregnantNow_no, possibilityPregnantDescribe, lactating_yes, lactating_no, peds_na, deliveryType, preemie, birthWeight, immunizationDate_yes, immunizationDate_no, immunizationDetails, respiratoryInfection_no, respiratoryInfection_yes, respiratoryInfectionDetails, communicableDisease_measles, communicableDisease_chicken_pox, communicableDisease_tb, communicableDisease_meningitis, communicableDisease_na, communicableDiseaseOthers, pedsComment, culturalSurgery_yes, culturalSurgery_no, dayOfSurgery, livesAlone_yes, livesAlone_no, typeOfHouse, stairs, alcohol_yes, alcohol_no, freq, alcoholOther, alcoholAmount, drugs_yes, drugs_no, drugsFreq, drugsOther, drugslAmount, lastDoseAmount, caffeine_yes, caffeine_no, caffeineFreq, caffeineOther, caffeineAmount, cigarettesVaping_yes, cigarettesVaping_no, packsPerDay, lastCigarette, cigars_yes, cigars_no, cigarsPerDay, lastCigar, readinessToQuit, psychosocialComment, reportedPsychiatricProblem_yes, reportedPsychiatricProblem_no, anxiety_yes, anxiety_no, hallucinations_yes, hallucinations_no, depressions_yes, depressions_no, postTraumaticReaction_yes, postTraumaticReaction_no, suicidalIdeations_yes, suicidalIdeations_no, suicidalOther, onMeds9_yes, onMeds9_no, followedByMD_yes, followedByMD_no, psychiatricComment, afraidOfAnyyone_yes, afraidOfAnyyone_no, afraidOfAnyyone_unable_to_access, afraid, unableAfraid, isAnyoneHurtingYou_yes, isAnyoneHurtingYou_no, isAnyoneHurtingYou_unable_to_access, hurting, unableHurting, talkSomeone_yes, talkSomeone_no, talkSomeone_unable_to_access, unableTalk, abuseScreenComments, placeYouDoNotFeelSafe_yes, placeYouDoNotFeelSafe_no, placeYouDoNotFeelSafe_unable_to_access, feelSafeYes, unableFeelSafe, isAnyoneHurtingYou1_yes, isAnyoneHurtingYou1_no, isAnyoneHurtingYou1_unable_to_access, hurtingYes, unableToHurting, afraidOfAnyone_yes, afraidOfAnyone_no, afraidOfAnyone_unable_to_access, personAfraid, otherPersonAfraid, unableToAssess, abuseScreenComments1, nameOfPhysician, nameOfPhysicianDate, nameOfPhysicianTime, nameOfSocialWorker, nameOfSocialWorkerDate, nameOfSocialWorkerTime,mongo_id))
                print("Executed UPDATE for document with mongo_id in completeNursingAssessmentPartC:", mongo_id)
            except Exception as e:
        ...
        # If the record doesn't exist, perform an INSERT operation
            ...
            try:
                ...
                print("Documents inserted for completeNursingAssessmentPartA",mysql_valuesA)
                ...
                print("Documents inserted for completeNursingAssessmentPartB",mysql_valuesB)
                ...
                print("Documents inserted for completeNursingAssessmentPartC",mysql_valuesC)
